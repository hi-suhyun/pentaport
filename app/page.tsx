    ...
    ko: {
      ...
      story: [
      {
        ...
        paragraphs: [
          ...
          {
            text: '배를 두드리며 만족한 호랑이는 이제 남은 아이들까지 잡아먹으려 어머니 옷을 걸치고 그 집 문 앞에 섰습니다. "애들아, 엄마다. 문 좀 열어다오." 그러나 그 목소리는 당지 않았지요.',
            image: "/images/3.png",
          },
        ],
      },
      {
        ...
        paragraphs: [
          {
            text: '기백서 문을 열려던 여동생을 오빠는 제빨리 막아서며 말했어요. "그럼, 손을 내밀어 봐." 그 순간 하늘에서 밧줄이 내려왔고, 그들 사이로 번뜩이는 노란 눈동자가 지켜보고 있었습니다. 남매는 그게 호랑이인 걸 단번에 눈치채고, 숨을 쉬지 않고 뒷문으로 빠져나가 높은 나무 위로 올라가 몸을 숨겼습니다.',
            image: "/images/4.png",
          },
          {
            text: "분노한 호랑이는 나무 아래에서 으르렁거리며 손을 빨았지만, 오누이의 몸에는 닿지 않았지요. 본노한 호랑이는 나무 아래에서 으르렁거리며 손을 빨았지만, 오누이의 몸에는 닿지 않았지요.",
            image: "/images/5.png",
          },
          {
            text: '결국 남매는 하늘을 향해 두 손을 모으고 빌었습니다. "하느님, 저희를 구해주시려면 새 동아줄을 내려 주시고, 아니시라면 썩은 줄을 내려 주세요." 그 순간 하늘에서 밧줄이 내려왔고, 남매는 그 줄을 타고 하늘로 올라가 해와 달이 되어 세상을 비추는 존재가 되었답니다.',
            image: "/images/6.png",
          },
        ],
      },
